...
**Hook scaffolding examples** (one `.sh` for each of the eight hook events I use most). Q1: pattern (the shape of a hook script). Q2: no setup. Q3: LITE definitely feels gimped without these — users would have to write hooks from scratch. → **LITE.** Shipped.
